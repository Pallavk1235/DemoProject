      ...
      <form role="form" action="{{route('door.storemain')}}" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <input type="text" name="door_main_stock" id="door_main_stock" class="form-control @error('door_main_stock') is-invalid @enderror" value="{{old('door_main_stock')}}" placeholder="">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="form-group">
              <label>Details</label>
              <textarea class="form-control" rows="3" name="door_main_details" id="door_main_details" class="form-control @error('door_main_details') is-invalid @enderror" value="{{old('door_main_details')}}" placeholder=""></textarea>
